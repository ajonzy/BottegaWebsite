            ...
            <div className="privacy-policy-content-wrapper">
                <div className="privacy-policy-content">
                    <div className="wrapper">
                        ...
                        <div className="policy-blocks-wrapper">
                            ...
                            <div className="content-block">
                                ...
                                <p>We do not use vulnerability scanning and/or scanning to PCI standards.<br/>We only provide articles and information. We never ask for credit card numbers.<br/>We use regular Malware Scanning.</p>
                            </div>

                            <div className="content-block">
                                <p><strong>We do not use an SSL certificate</strong></p>
                                <ul>
                                    <li>We do not need an SSL because:<br/>We do not store any information on our server or collect any payment information.</li>
                                </ul>
                            </div>
                            ...
                            <div className="content-block">
                                ...
                                <p>Google’s advertising requirements can be summed up by Google’s Advertising Principles. They are put in place to provide a positive experience for users. <br/>https://support.google.com/adwordspolicy/answer/1316548?hl=en</p>
                            </div>
                            ...
                            <div className="content-block">
                                ...
                                <p>In order to be in line with Fair Information Practices we will take the following responsive action, should a data breach occur:<br/>We will notify you via email<br/>• Within 1 business day</p>
                            ...
                            <div className="content-block">
                                ...
                                <p>bottega.tech<br/>2912 Executive Parkway<br/>Lehi, UT 84043<br/>United States<br/>support@bottega.tech<br/>801-980-3664</p>
                                <p>Last Edited on 2019-08-13</p>
                            </div>
                        </div>
                    </div>
                </div>
